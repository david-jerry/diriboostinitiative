...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["diriboostinitiative.com.ng"])
...
# STATIC
# ------------------------
STATICFILES_STORAGE = "diri.utils.storages.StaticRootS3Boto3Storage"
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[DIRIBOOST INITIATIVE]"
)
